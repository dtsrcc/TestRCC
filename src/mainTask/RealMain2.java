...
public class RealMain2 extends Task
{
	long time;
	long setTimeStamp = 0;
	...
	public RealMain2() throws Exception{
	...
	if(switch1State == true) {
		...
		switch (state) {
			...
			case 4:		//******************************************************Case 4 grab or stack*************************************************************************
				...
				if (stateInCase == 1 && (dcmLift.getActualPos() > -1050000) && (dcmLift.getActualPos() < - 550000) && (time >= setTimeStamp + 2000000)) {
				...
				if (stateInCase == 2 && dcmLift.getActualPos() > -2650000 && dcmLift.getActualPos() < - 1850000 && time >= setTimeStamp + 2000000)  {
...
//					System.out.println("Case 3 // Lower grabbing position");
			...
			case 10:
				dcmDrive.setTargetPos(20000);
				//System.out.println("Case 10 // Move forward to regrab tower");
				
				dcmLift.setZeroSwitch();
				//System.out.println("Case 10 // Place tower");
				
				if (stateInCase == 3 && dcmLift.getActualPos() < 2000 && dcmLift.getActualPos() > -2000) {
					ServoGripper.setPosition(angleOpen);	// Open Gripper
					//System.out.println("Case 10 // Open Gripper");
					
					dcmDrive.setTargetPos(0);
					dcmDrive.setVariabletrue();
			...
			case 11:	//******************************************************Case 11 another pressing*************************************************************************
				...
				if (dcmLift.getActualPos() < -2700000 && time >= setTimeStamp + 2000000) {
				...
				if (stateInCase == 4 && dcmLift.getActualPos() > -2800000 && dcmLift.getActualPos() < - 2200000 && time >= setTimeStamp + 1500000) {
				...
				if (stateInCase == 3 && dcmLift.getActualPos() < -400000 && dcmLift.getActualPos() > -600000 && time >= setTimeStamp + 1000000) {
